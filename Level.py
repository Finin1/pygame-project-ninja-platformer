...
rooms = [
    {'id': 1, 'npc': [], 'platforms': [pygame.Rect(0, 800, 1600, 100), pygame.Rect(0, 900, 1600, 1)], 'start_type': 1,
     'exit_type': 1},
    {'id': 2, 'npc': [],
     'platforms': [pygame.Rect(0, 800, 450, 100), pygame.Rect(0, 900, 1600, 1), pygame.Rect(575, 650, 500, 50),
                   pygame.Rect(1200, 500, 500, 600)], 'start_type': 1, 'exit_type': 2},
    {'id': 3, 'npc': [],
     'platforms': [pygame.Rect(1200, 800, 450, 100), pygame.Rect(0, 900, 1600, 1), pygame.Rect(575, 650, 500, 50),
                   pygame.Rect(0, 500, 500, 600)], 'start_type': 2, 'exit_type': 1}
    ]  # Варианты комнат
